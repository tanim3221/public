...
<head>
	...
	<title>From general members </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">From general members </h2>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
										<th>#</th>
											<th><b>Photo</th><th><b>Mermber ID</th> <th><b>Name</th> <th><b>Bachelor Year</th><th><b>Master Year</th><th><b>Action</th><th><b>Details</th><th><b>Update</th>
										</tr>
									</thead>
									<tfoot>
										<tr>
...
<?php $sql = "SELECT * from  lifemembers WHERE MemId LIKE 'M%' ORDER by MemId ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
			<tr>
				...
				<td>
				<a type="button" class="btn btn-danger" href="moved-from-member.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete this record')"> Delete</a>
				</td>
