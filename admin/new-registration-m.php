...
<head>
	...
	<title>New Registration (General Member) </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">New Registration (General Member)</h2>
...
$sql = "SELECT * FROM member WHERE active='0' ORDER by MemId";
...
{				?>	
	...
	<td>  
				...
				{?>
				<a type="button" class="btn btn-danger" href="new-registration-m.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to avtive this member?')">  Inactive </a> 
				<?php } else {?>

				<a type="button" class="btn btn-success" href="new-registration-m.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to inavtive this member?')">  Active </a>
