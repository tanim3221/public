...
if(isset($_GET['Serial'])){
  ...
  member ON participants.id = member.id WHERE participants.CategoryM IN ('Member') AND Serial =" .$_GET['Serial'];
...
<table id="pay-fees" width="100%">
    <tbody>
        <tr id="heading">
            ...
            <td width="12%">
                <p><img style='width: 90px; float:right;' src='../img/m/<?php echo $row["Image"]; ?>'></p>
            </td>
        </tr>
