			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Life Member's</h2>
				...
				<a class="btn btn-primary" type="button" href="download-records-LM.php">Download LM Member's List</a></div>
...
<?php $sql = "SELECT * from  lifemembers WHERE CategoryM IN ('LM') ORDER by MemId LIMIT 5";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
			<tr>
				...
				{?>
				<a type="button" class="btn btn-warning" href="life-member.php?comm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to add to committee?')">  Add to <br> Committee </a> 
				<?php } else {?>

				<a type="button" class="btn btn-info" href="life-member.php?noncomm=<?php echo htmlentities($result->id);?>" onclick="return confirm(' Do you really want to remove from committee?')">  Remove </a>
				...
				{?>
				<a type="button" class="btn btn-danger" href="life-member.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to avtive this member?')">  Inactive </a> 
				<?php } else {?>
            <div class="btn-group-vertical">
				<a type="button" class="btn btn-success" href="life-member.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to inavtive this member?')">  Active </a>
			...
			<td>  
				...
				{?>
				<a type="button" class="btn btn-warning" href="life-member.php?participants=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to add to participants List?')">  Add to  <br> Participants List </a> 
				<?php } else {?>

				<a type="button" class="btn btn-info" href="life-member.php?nonparticipants=<?php echo htmlentities($result->id);?>" onclick="return confirm(' Do you really want to remove from participants List?')"> Removed from <br> Participants List </a>
