		...
		<div class="content-wrapper">
          ...
          <div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Image Changes - Life Members</h2>
                        ...
                        <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							...
							<?php
								...
								$result = $conn->prepare("SELECT * FROM lifemembers ORDER BY Case LEFT (MemId, 2 )
                WHEN 'GD' Then 1
                WHEN 'DD' Then 2
                WHEN 'GM' Then 3
                WHEN 'LM' Then 4
                Else 5 End , MemId");
							...
							?>
								...
								<td>
									<?php if($row['Image'] != ""): ?>
									<img src="../img/lm/<?php echo $row['Image']; ?>" width="100px" >
									<?php else: ?>
									<img src="" width="100px" >
									<?php endif; ?>
								</td>
							...
							<?php endif; ?>
							<form action="edit-image.php<?php echo '?id='.$id; ?>" method="post" enctype="multipart/form-data">
							<div class="editimage">
