...
$status="0";
$sql = "UPDATE member SET Status=:status WHERE  id=:eid";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">All General Member's</h2>
...
$sql = "SELECT * From member ORDER by MemId";
...
{				?>	
				...
				<td><?php echo htmlentities($result->Bachelor);?></td>
											<td>
											    <a type="button" class="btn btn-danger" href="general-member-all.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete member')"> Delete</a>
                                             </td>
                                             <td>
                                             <a type="button" class="btn btn-primary" href="details-view-m.php?id=<?php echo htmlentities($result->id);?>" target="_blank">  Details View </a> 
                                                 <a type="button" class="btn btn-danger" href="edit-general-member.php?id=<?php echo htmlentities($result->id);?>"> Update </a> 
                                            </td>
