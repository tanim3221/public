...
<head>
	...
	<title>Distinguished Donor Member</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Distinguished Donor Member</h2>

						<!-- Zero Configuration Table -->
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
				<div class="btn-data-download">
				<a class="btn btn-primary" type="button" href="download-records-DDM.php">Download DDM Member's List</a></div>
								...
								<th><b>Name</th> 
								<th><b>Mobile</th>
								<th><b>Bachelor Year</th><th><b>Committee</th>
						<th><b>Status</th><th><b>Details</th>
								<th><b>Update</th> <th><b>Participants</th>
										</tr>
									</thead>
									<tfoot>
										<tr>
...
<?php $sql = "SELECT * from  lifemembers WHERE CategoryM IN ('DDM') ORDER by MemId ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
		...
		<td>  
				...
				{?>
				<a type="button" class="btn btn-warning" href="distinguished-donor-member.php?comm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to add to committee?')">  Add to Committee </a> 
				<?php } else {?>

				<a type="button" class="btn btn-info" href="distinguished-donor-member.php?noncomm=<?php echo htmlentities($result->id);?>" onclick="return confirm(' Do you really want to remove from committee?')">  Remove </a>
		...
		<td>  
				...
				{?>
				<a type="button" class="btn btn-danger" href="distinguished-donor-member.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to avtive this member?')">  Inactive </a> 
				<?php } else {?>
             <div class="btn-group-vertical">
				<a type="button" class="btn btn-success" href="distinguished-donor-member.php?hidden=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to inavtive this member?')">  Active </a>
		...
		<td>
			...
			<td>  
				...
				{?>
				<a type="button" class="btn btn-warning" href="distinguished-donor-member.php?participants=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to add to participants List?')">  Add to  <br> Participants List </a> 
				<?php } else {?>

				<a type="button" class="btn btn-info" href="distinguished-donor-member.php?nonparticipants=<?php echo htmlentities($result->id);?>" onclick="return confirm(' Do you really want to remove from participants List?')"> Removed from <br> Participants List </a>
