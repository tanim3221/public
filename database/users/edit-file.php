...
<p><h2 class="GrayBlue22b">Update Profile </h2></p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img src="../img/lm/<?php echo $row['Image']; ?>" id="profile-img-tag" width="100px" />
                         ...
                         <br> <button type="button"  class="btn btn-outline-danger btn-sm" href="javascript:void(0)" onclick="location.href='change-photo.php'">Change Photo</button> 
                        </div>
