<h2 class="GrayBlue22b"> List of General Members </h2>
...
<?php
		$sql="SELECT * From member WHERE YearM >=CURDATE() - INTERVAL 2 Year AND active='1' ORDER BY MemId";
